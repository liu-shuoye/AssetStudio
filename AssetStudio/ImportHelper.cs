...
namespace AssetStudio
{
    ...
    public static class ImportHelper
    {
        ...
        private static readonly byte[] OrisriesMagic = { 0x10, 0x00, 0x00, 0x00 };
        ...
        public static FileReader DecryptOrisries(FileReader reader)
        {
            ...
            if (!OrisriesMagic.SequenceEqual(dataTmp[(decryptSize - 4)..]))
            {
                reader.Position = 0;
                return reader;
            }
