...
namespace AssetStudio
{
    ...
    public static class ImportHelper
    {
        ...
        public static FileReader DecryptCounterSide(FileReader reader)
        {
            ...
            MaskList[0] = UInt64.Parse(hex.Substring(0, 16), NumberStyles.HexNumber);
            MaskList[1] = UInt64.Parse(hex.Substring(16, 16), NumberStyles.HexNumber);
            MaskList[2] = UInt64.Parse(hex.Substring(0, 8) + hex.Substring(16, 8), NumberStyles.HexNumber);
            MaskList[3] = UInt64.Parse(hex.Substring(8, 8) + hex.Substring(24, 8), NumberStyles.HexNumber);
            var pos = 0;
            var maskPos = 0;
