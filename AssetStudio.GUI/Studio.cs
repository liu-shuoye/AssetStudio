...
namespace AssetStudio.GUI
{
    ...
    internal static class Studio
    {
        ...
        private static readonly Dictionary<Texture2D, SortedDictionary<string, Sprite>> SpriteAtlasSplitData = new();
        ...
        public static void ExportSpriteAtlasInfo(string exportPath)
        {
            foreach (var spriteAtlasSplitDataKeyValue in SpriteAtlasSplitData)
            {
                ...
                foreach (var sprite in spriteAtlasSplitDataKeyValue.Value)
                {
